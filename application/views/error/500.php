...
<div id="header">
	<?php
	$messages = array('Whoops!', 'Ow no!', 'Outch!');
	$message = $messages[mt_rand(0, 2)];
	?>
	<h1 class="aurora"><?php echo $message; ?></h1>
</div>
...
<div id="wrapper">
	...
	<p>Something failed while we were handling your request. Would you like to go to our <a href="<?php echo System\Config::get('application.url'); ?>">home page</a> instead?</p>
</div>
</body>
</html>